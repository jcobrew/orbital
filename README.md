...
- **Map** (`startup-programs-map.html`) — the landing page. A 2D Leaflet map. Dense regions
...
`startup-programs-map.html` (a region needs at least 3 programs in the active dataset to appear).
...
# then open http://localhost:8000/startup-programs-map.html
```
